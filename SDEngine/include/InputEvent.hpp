...
struct MousePressedEvent : InputEvent {
  ...
  MousePressedEvent(int button, int mods, bool repeat) :
    InputEvent{}, button(button), mods(mods), repeat(repeat) {}
  [[nodiscard]] InputEventCategory category() const override {
    return InputEventCategory::MousePressed;
  }
};
...
struct MouseReleasedEvent : InputEvent {
  ...
  [[nodiscard]] InputEventCategory category() const override {
    return InputEventCategory::MouseReleased;
  }
};
...
struct KeyPressedEvent : InputEvent {
  ...
  [[nodiscard]] InputEventCategory category() const override {
    return InputEventCategory::KeyPressed;
  }
};
...
struct KeyReleasedEvent : InputEvent {
  ...
  KeyReleasedEvent(int key, int scancode, int mods) :
    InputEvent{}, key(key), scancode(scancode), mods(mods) {}
  [[nodiscard]] InputEventCategory category() const override {
    return InputEventCategory::KeyReleased;
  }
};
...
struct ScrollEvent : InputEvent {
  ...
  [[nodiscard]] InputEventCategory category() const override {
    return InputEventCategory::MouseScroll;
  }
  ScrollEvent() = default;
...
struct CursorEvent : InputEvent {
  ...
  [[nodiscard]] InputEventCategory category() const override {
    return InputEventCategory::CursorPos;
  }
  CursorEvent() = default;
