...
static SD::Application* ToApp(SD_Application* app) { return reinterpret_cast<SD::Application*>(app); }
static SD::Scene* ToScene(SD_Scene* scene) { return reinterpret_cast<SD::Scene*>(scene); }
static SD_Application* FromApp(SD::Application* app) { return reinterpret_cast<SD_Application*>(app); }
static SD_Scene* FromScene(SD::Scene* scene) { return reinterpret_cast<SD_Scene*>(scene); }
...
static void GameOnLoad(SD_Application* appPtr, GameState* state) {
    ...
    auto& ctrl = app.PushViewLayer<SD::Panel>(mainWin, "Sandbox Controls", ToScene(state->anotherScene));
    ...
    gameView.PushLayer<GameRenderLayer>(1, "GameRender", ToScene(state->sharedScene), worldPipe, worldPipe, pushLayout);
