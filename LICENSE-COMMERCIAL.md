...
- Offer hosted or SaaS‑style engine offerings.
- OEM‑bundle the engine as part of your software stack.

This license does not affect the separate MIT license for using the engine to build games; those uses remain under the standard MIT terms.
